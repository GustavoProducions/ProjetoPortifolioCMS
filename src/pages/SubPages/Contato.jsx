...
const ContactForm = () => {
  ...
  return (
    ...
    >
      ...
      <Card className="border-none w-full md:w-2/5 bg-slate-200">
        <CardContent>
          <CardTitle className="text-[#2893B3] text-center mb-10 text-[22px] items-center">
            <h1 className="text-4xl">Nos envie uma mensagem</h1>
            <h3 className='text-lg text-slate-500 text-opacity-3'>Entre em contato para dúvidas e informações</h3>
          </CardTitle>
      ...
      <Card className="border-none w-full md:w-2/5 flex flex-col justify-center items-center text-center">
        <CardContent>
          <CardTitle className="text-[#2893B3] text-[22px] mb-6">Entre em Contato</CardTitle>
